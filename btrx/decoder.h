...
private:
	...
	uint8_t GfPow(uint8_t,uint8_t);
	uint8_t GfPow2(uint8_t);
	uint8_t GfInv(uint8_t);
	void    GfPolyScale(uint8_t *,uint8_t,uint8_t,uint8_t *);
	uint8_t GfPolyAdd(uint8_t *,uint8_t,uint8_t *,uint8_t,uint8_t *);
	void    GfPolyMul(uint8_t *,uint8_t,uint8_t *,uint8_t,uint8_t *);
	uint8_t GfPolyEval(uint8_t *,uint8_t,uint8_t);
	void    GfPolyInv(uint8_t *,uint8_t);
	uint8_t commonBuffer[4 * RS_MAX_REDUNDANCY_BYTES + 4];

	void syndromes(uint8_t *,uint8_t,uint8_t *);
	bool errorEvaluator(uint8_t *,uint8_t,uint8_t *);
	bool errorLocator(uint8_t *,uint8_t *,uint8_t *);
	bool fix(uint8_t *,uint8_t,uint8_t *,uint8_t *,uint8_t);
	bool checkSyndromes(uint8_t *,uint8_t);
public:
	bool RsDecode(uint8_t *,uint8_t,uint8_t *);
	decoder(uint8_t, uint8_t);
};
